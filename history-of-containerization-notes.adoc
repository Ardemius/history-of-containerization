...
=== 2022 - WebAssembly (WASM), modules WASM, containers Javascript et Deno
...
* *Définition de WebAssembly*
    ** https://fr.wikipedia.org/wiki/WebAssembly : 
        *** WebAssembly, abrégé wasm, est un *standard* du World Wide Web pour le développement d’applications +
...
* *Bytecode Alliance* (BCA) : un partenariat industriel poussant le développement de Wasm, tout particulièrement en dehors du browser
    ...
    ** 2019/11/12 (ATTENTION ! Cela a donc déjà 3 ans (2023) ) - https://hacks.mozilla.org/2019/11/announcing-the-bytecode-alliance/ : "*Announcing* the Bytecode Alliance: Building a secure by default, composable future for WebAssembly"
...
* Très bon article, récent (2022/08) sur le fonctionnement des WASM nanoprocess : https://blog.jdriven.com/2022/08/wasi-capability-based-networking/
...
* TODO : rechercher les différences entre les module WASM et les containers
    ** comparatif : avantages / inconvénients ou forces / faiblesses des uns par rapport aux autres
    ** Bien insister sur ce que ne permettent PAS les modules WASM ou les nanoprocess WASM

* TODO : regarder en détails la création d'un module WASM
    ** et la comparer à la structure en "layer" d'un container Docker
* TODO : rechercher la différence entre un module WASM et un nanoprocess WASM

* TODO : rechercher la taille et les ressources utilisées par le "plus petit container possible" et les comparer à celles d'un module WASM
